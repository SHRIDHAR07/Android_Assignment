...
public class LoginFragment extends Fragment implements View.OnClickListener {
    ...
    private void onSignUpButtonClick() {
       /* NavController navController= Navigation.findNavController(getActivity(),R.id.nav_host_fragment);
        ...
        navController.navigate(R.id.action_fragment_Login2_to_fragment_Registration2);
    }
        ...
        if (isValid()) {
            if (mUserName.getText().toString().equals("123") && mPassword.getText().toString().equals("123")){
              ...
              /*  NavController navController= Navigation.findNavController(getActivity(),R.id.nav_host_fragment);
                ...
                NavController navController= Navigation.findNavController(getActivity(),R.id.shopping_nav_host_fragment);
                navController.navigate(R.id.action_fragment_Login2_to_fragmentShoppingHomeScreen);
